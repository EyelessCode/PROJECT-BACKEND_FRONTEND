...
class TomaSignosRepositorio {
    ...
    actualizarTomaSigno(codigo, data) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield prisma_service_1.prisma.tomaSignos.update({
                where: {
                    numero: codigo
                },
                data: data
    ...
    eliminarTomaSigno(codigo) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield prisma_service_1.prisma.tomaSignos.delete({
                where: {
                    numero: codigo
                }
            });
